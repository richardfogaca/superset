...
const columnsConfig = dndAllColumns;
  ...
  controlPanelSections: [
    ...
    },
    {
      ...
      controlSetRows: [
        ...
        [
          {
            name: 'custom_order_x_axis',
            config: {
              type: 'TextControl',
              label: t('Custom order x axis'),
              renderTrigger: true,
              description: t(
                'A sequence of letters that define the order of x axis items.',
              ),
              visibility: ({ controls }) =>
                controls.sort_x_axis.value === 'custom',
            },
          },
        ],
        [
        ...
        [
          {
            name: 'custom_order_y_axis',
            config: {
              type: 'TextControl',
              label: t('Custom order y axis'),
              renderTrigger: true,
              description: t(
                'A sequence of letters that define the order of y axis items.',
              ),
              visibility: ({ controls }) =>
                controls.sort_y_axis.value === 'custom',
            },
          },
        ],
        [
